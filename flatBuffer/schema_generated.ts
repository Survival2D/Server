...
export function unionToEquipment(
  type: Equipment,
  accessor: (obj:Sample.Weapon) => Sample.Weapon|null
): Sample.Weapon|null {
  switch(Sample.Equipment[type]) {
    case 'NONE': return null; 
    case 'Weapon': return accessor(new Sample.Weapon())! as Sample.Weapon;
    default: return null;
  }
}
...
export function unionListToEquipment(
  type: Equipment, 
  accessor: (index: number, obj:Sample.Weapon) => Sample.Weapon|null, 
  index: number
): Sample.Weapon|null {
  switch(Sample.Equipment[type]) {
    case 'NONE': return null; 
    case 'Weapon': return accessor(index, new Sample.Weapon())! as Sample.Weapon;
    default: return null;
  }
}
}
...
/**
 * @param Sample.Vec3= obj
 * @returns Sample.Vec3|null
 */
pos(obj?:Sample.Vec3):Sample.Vec3|null {
  var offset = this.bb!.__offset(this.bb_pos, 4);
  return offset ? (obj || new Sample.Vec3()).__init(this.bb_pos + offset, this.bb!) : null;
};
...
color():Sample.Color {
  ...
  return offset ? /**  */ (this.bb!.readInt8(this.bb_pos + offset)) : Sample.Color.Blue;
};

/**
 * @param number index
 * @param Sample.Weapon= obj
 * @returns Sample.Weapon
 */
weapons(index: number, obj?:Sample.Weapon):Sample.Weapon|null {
  var offset = this.bb!.__offset(this.bb_pos, 18);
  return offset ? (obj || new Sample.Weapon()).__init(this.bb!.__indirect(this.bb!.__vector(this.bb_pos + offset) + index * 4), this.bb!) : null;
};
...
/**
 * @returns Sample.Equipment
 */
equippedType():Sample.Equipment {
  var offset = this.bb!.__offset(this.bb_pos, 20);
  return offset ? /**  */ (this.bb!.readUint8(this.bb_pos + offset)) : Sample.Equipment.NONE;
};
 ...
 * @returns Sample.Vec3
 */
path(index: number, obj?:Sample.Vec3):Sample.Vec3|null {
  var offset = this.bb!.__offset(this.bb_pos, 24);
  return offset ? (obj || new Sample.Vec3()).__init(this.bb!.__vector(this.bb_pos + offset) + index * 12, this.bb!) : null;
};
...
/**
 * @param flatbuffers.Builder builder
 * @param Sample.Color color
 */
static addColor(builder:flatbuffers.Builder, color:Sample.Color) {
  builder.addFieldInt8(6, color, Sample.Color.Blue);
};
...
/**
 * @param flatbuffers.Builder builder
 * @param Sample.Equipment equippedType
 */
static addEquippedType(builder:flatbuffers.Builder, equippedType:Sample.Equipment) {
  builder.addFieldInt8(8, equippedType, Sample.Equipment.NONE);
};
...
static createMonster(builder:flatbuffers.Builder, posOffset:flatbuffers.Offset, mana:number, hp:number, nameOffset:flatbuffers.Offset, inventoryOffset:flatbuffers.Offset, color:Sample.Color, weaponsOffset:flatbuffers.Offset, equippedType:Sample.Equipment, equippedOffset:flatbuffers.Offset, pathOffset:flatbuffers.Offset):flatbuffers.Offset {
