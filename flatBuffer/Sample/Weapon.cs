...
public struct Weapon : IFlatbufferObject
{
  ...
  public static Offset<Sample.Weapon> CreateWeapon(FlatBufferBuilder builder,
  ...
  public static Offset<Sample.Weapon> EndWeapon(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Sample.Weapon>(o);
  }
};
