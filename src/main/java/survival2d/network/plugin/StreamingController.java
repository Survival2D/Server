...
import survival2d.flatbuffers.Color;
import survival2d.flatbuffers.Equipment;
import survival2d.flatbuffers.Monster;
import survival2d.flatbuffers.Weapon;
...
import lombok.val;
import survival2d.flatbuffers.Weapon.Vector;
...
public class StreamingController extends EzyAbstractZoneEventController<EzyStreamingEvent> {
  ...
  public void handle(EzyZoneContext ezyZoneContext, EzyStreamingEvent ezyStreamingEvent) {
    val data = Arrays.copyOfRange(ezyStreamingEvent.getBytes(), 1, ezyStreamingEvent.getBytes().length);
    ...
    Vector weaponsVector = monster.weaponsVector();
    ...
    log.info("raw {}", ezyStreamingEvent.getBytes());
    ezyZoneContext.stream(ezyStreamingEvent.getBytes(), ezyStreamingEvent.getSession());
  }
}
