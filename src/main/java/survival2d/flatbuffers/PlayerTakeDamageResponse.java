...
public final class PlayerTakeDamageResponse extends Table {
  ...
  public static PlayerTakeDamageResponse getRootAsPlayerTakeDamageResponse(ByteBuffer _bb) {
    return getRootAsPlayerTakeDamageResponse(_bb, new PlayerTakeDamageResponse());
  }

  public static PlayerTakeDamageResponse getRootAsPlayerTakeDamageResponse(
      ByteBuffer _bb, PlayerTakeDamageResponse obj) {
    _bb.order(ByteOrder.LITTLE_ENDIAN);
    return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb));
  }

  public static int createPlayerTakeDamageResponse(
      FlatBufferBuilder builder, int usernameOffset, double remainHp) {
  ...
  public static void startPlayerTakeDamageResponse(FlatBufferBuilder builder) {
    builder.startTable(2);
  }
  ...
  public PlayerTakeDamageResponse __assign(int _i, ByteBuffer _bb) {
    __init(_i, _bb);
    return this;
  }
  ...
  public static final class Vector extends BaseVector {
    ...
    public PlayerTakeDamageResponse get(int j) {
      return get(new PlayerTakeDamageResponse(), j);
    }

    public PlayerTakeDamageResponse get(PlayerTakeDamageResponse obj, int j) {
