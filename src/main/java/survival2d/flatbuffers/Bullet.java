...
public final class Bullet extends Table {
  ...
  public static Bullet getRootAsBullet(ByteBuffer _bb) {
    return getRootAsBullet(_bb, new Bullet());
  }

  public static Bullet getRootAsBullet(ByteBuffer _bb, Bullet obj) {
    _bb.order(ByteOrder.LITTLE_ENDIAN);
    return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb));
  }

  public static void startBullet(FlatBufferBuilder builder) {
  ...
  public static void addDirection(FlatBufferBuilder builder, int directionOffset) {
    builder.addStruct(4, directionOffset, 0);
  }
  ...
  public Bullet __assign(int _i, ByteBuffer _bb) {
    __init(_i, _bb);
    return this;
  }
  ...
  public static final class Vector extends BaseVector {
    ...
    public Bullet get(int j) {
      return get(new Bullet(), j);
    }

    public Bullet get(Bullet obj, int j) {
