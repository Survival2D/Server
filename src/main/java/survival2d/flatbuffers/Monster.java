...
public final class Monster extends Table {
  ...
  public survival2d.flatbuffers.Vec3 pos() { return pos(new survival2d.flatbuffers.Vec3()); }
  public survival2d.flatbuffers.Vec3 pos(survival2d.flatbuffers.Vec3 obj) { int o = __offset(4); return o != 0 ? obj.__assign(o + bb_pos, bb) : null; }
  ...
  public survival2d.flatbuffers.Weapon weapons(int j) { return weapons(new survival2d.flatbuffers.Weapon(), j); }
  public survival2d.flatbuffers.Weapon weapons(survival2d.flatbuffers.Weapon obj, int j) { int o = __offset(18); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  public int weaponsLength() { int o = __offset(18); return o != 0 ? __vector_len(o) : 0; }
  public survival2d.flatbuffers.Weapon.Vector weaponsVector() { return weaponsVector(new survival2d.flatbuffers.Weapon.Vector()); }
  public survival2d.flatbuffers.Weapon.Vector weaponsVector(survival2d.flatbuffers.Weapon.Vector obj) { int o = __offset(18); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  ...
  public survival2d.flatbuffers.Vec3 path(int j) { return path(new survival2d.flatbuffers.Vec3(), j); }
  public survival2d.flatbuffers.Vec3 path(survival2d.flatbuffers.Vec3 obj, int j) { int o = __offset(24); return o != 0 ? obj.__assign(__vector(o) + j * 12, bb) : null; }
  public int pathLength() { int o = __offset(24); return o != 0 ? __vector_len(o) : 0; }
  public survival2d.flatbuffers.Vec3.Vector pathVector() { return pathVector(new survival2d.flatbuffers.Vec3.Vector()); }
  public survival2d.flatbuffers.Vec3.Vector pathVector(survival2d.flatbuffers.Vec3.Vector obj) { int o = __offset(24); return o != 0 ? obj.__assign(__vector(o), 12, bb) : null; }
  public long time() { int o = __offset(26); return o != 0 ? bb.getLong(o + bb_pos) : 0L; }
  ...
  public static void addTime(FlatBufferBuilder builder, long time) { builder.addLong(11, time, 0L); }
