...
public final class JoinTeamResponse extends Table {
  ...
  public static int createJoinTeamResponse(FlatBufferBuilder builder,
      int teamId) {
    builder.startTable(1);
    JoinTeamResponse.addTeamId(builder, teamId);
    return JoinTeamResponse.endJoinTeamResponse(builder);
  }

  public static void startJoinTeamResponse(FlatBufferBuilder builder) { builder.startTable(1); }
