...
public final class MapObject extends Table {
  ...
  public static MapObject getRootAsMapObject(ByteBuffer _bb) { return getRootAsMapObject(_bb, new MapObject()); }
  public static MapObject getRootAsMapObject(ByteBuffer _bb, MapObject obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public void __init(int _i, ByteBuffer _bb) { __reset(_i, _bb); }
  public MapObject __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static void startMapObject(FlatBufferBuilder builder) { builder.startTable(4); }
  ...
  public static final class Vector extends BaseVector {
    ...
    public MapObject get(int j) { return get(new MapObject(), j); }
    public MapObject get(MapObject obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
