...
public final class Packet extends Table {
  ...
  public static Packet getRootAsPacket(ByteBuffer _bb) {
    return getRootAsPacket(_bb, new Packet());
  }

  public static Packet getRootAsPacket(ByteBuffer _bb, Packet obj) {
    _bb.order(ByteOrder.LITTLE_ENDIAN);
    return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb));
  }

  public static int createPacket(FlatBufferBuilder builder, byte data_type, int dataOffset) {
  ...
  public static void finishPacketBuffer(FlatBufferBuilder builder, int offset) {
    builder.finish(offset);
  }

  public static void finishSizePrefixedPacketBuffer(FlatBufferBuilder builder, int offset) {
  ...
  public Packet __assign(int _i, ByteBuffer _bb) {
    __init(_i, _bb);
    return this;
  }
  ...
  public static final class Vector extends BaseVector {
    ...
    public Packet get(int j) {
      return get(new Packet(), j);
    }

    public Packet get(Packet obj, int j) {
