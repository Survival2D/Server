...
public final class Wall extends Table {
  ...
  public static void startWall(FlatBufferBuilder builder) { builder.startTable(0); }
  ...
  public static final class Vector extends BaseVector {
    ...
    public Wall get(int j) { return get(new Wall(), j); }
    public Wall get(Wall obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
