...
import com.survival2d.server.exception.CreateRoomNotFromLobbyException;
import com.survival2d.server.game.MMORoomFactory;
...
public class RoomServiceImpl extends EzyLoggable implements RoomService {
  ...
  public List<Long> getMMORoomIdList() {
    return globalRoomManager.getRoomList().stream()
