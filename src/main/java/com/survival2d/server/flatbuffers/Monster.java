...
public final class Monster extends Table {
  ...
  public com.survival2d.server.flatbuffers.Weapon weapons(int j) { return weapons(new com.survival2d.server.flatbuffers.Weapon(), j); }
  public com.survival2d.server.flatbuffers.Weapon weapons(com.survival2d.server.flatbuffers.Weapon obj, int j) { int o = __offset(18); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  public int weaponsLength() { int o = __offset(18); return o != 0 ? __vector_len(o) : 0; }
  public com.survival2d.server.flatbuffers.Weapon.Vector weaponsVector() { return weaponsVector(new com.survival2d.server.flatbuffers.Weapon.Vector()); }
  public com.survival2d.server.flatbuffers.Weapon.Vector weaponsVector(com.survival2d.server.flatbuffers.Weapon.Vector obj) { int o = __offset(18); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  ...
  public com.survival2d.server.flatbuffers.Vec3 path(int j) { return path(new com.survival2d.server.flatbuffers.Vec3(), j); }
  public com.survival2d.server.flatbuffers.Vec3 path(com.survival2d.server.flatbuffers.Vec3 obj, int j) { int o = __offset(24); return o != 0 ? obj.__assign(__vector(o) + j * 12, bb) : null; }
  public int pathLength() { int o = __offset(24); return o != 0 ? __vector_len(o) : 0; }
  public com.survival2d.server.flatbuffers.Vec3.Vector pathVector() { return pathVector(new com.survival2d.server.flatbuffers.Vec3.Vector()); }
  public com.survival2d.server.flatbuffers.Vec3.Vector pathVector(com.survival2d.server.flatbuffers.Vec3.Vector obj) { int o = __offset(24); return o != 0 ? obj.__assign(__vector(o), 12, bb) : null; }
