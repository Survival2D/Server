package com.survival2d.app;

import com.survival2d.common.constant.CommonConstants;
...
public class AppEntry extends EzyDefaultAppEntry {
  ...
  protected void preConfig(EzyAppContext ctx) {
    logger.info("\n=================== survival2d APP START CONFIG ================\n");
  }

  @Override
  protected void postConfig(EzyAppContext ctx) {
    logger.info("\n=================== survival2d APP END CONFIG ================\n");
  }
...
//    builder.addProperties(pluginProperties);
  ...
  protected String[] getScanablePackages() {
    return new String[] {"com.survival2d.common", "com.survival2d.app"};
  }
}
