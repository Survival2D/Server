...
import com.survival2d.app.constant.Errors;
import com.survival2d.app.request.GoRequest;
import com.survival2d.app.request.HelloRequest;
import com.survival2d.app.response.HelloResponse;
import com.survival2d.app.service.GreetingService;
...
public class GreetRequestController {
  ...
  @EzyAutoBind private GreetingService greetingService;
