...
import com.survival2d.ApplicationStartup;
...
public class ClientTest {
  ...
  public static void main(String[] args) {
    EzyClientConfig config =
        EzyClientConfig.builder().zoneName(ApplicationStartup.ZONE_APP_NAME).build();
  ...
  public static void setupClient(EzyClient client) {
    ...
    setup.addDataHandler(
        ...
        new EzyHandshakeHandler() {

          @Override
          protected EzyRequest getLoginRequest() {
            return new EzyLoginRequest(
                ApplicationStartup.ZONE_APP_NAME, "YoungMonkey", "YoungMonkey");
          }
        });
    setup.addDataHandler(
        EzyCommand.LOGIN,
        new EzyLoginSuccessHandler() {
          @Override
